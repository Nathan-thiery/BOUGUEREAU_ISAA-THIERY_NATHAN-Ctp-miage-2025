...
Le code n'est pas structuré en couche, l'intégralité des fichiers java sont dans le même dossier "Todolist".
Si le projet grandit, le manque de structure sera un impact chronophage dans la reprise du code par de nouveaux collaborateurs. 

*Où se trouve le code métier (voir la règle de gestion RG 1) ?*
Le code métier se trouve dans 
